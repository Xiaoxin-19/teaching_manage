...
func (r *RecordRepositoryImpl) GetRecordList(ctx context.Context, stuIDs []uint, teachIDs []uint, subjectIDs []uint,
	...
	for _, rec := range records {
		...
		result = append(result, entity.Record{
			...
			Student:       entity.Student{ID: rec.StudentID, Name: rec.Student.Name, StudentNumber: rec.Student.StudentNumber, Status: int(rec.Student.Status), DeletedAt: rec.Student.DeletedAt.Time},
			Teacher:       entity.Teacher{ID: rec.TeacherID, Name: rec.Teacher.Name, TeacherNumber: rec.Teacher.TeacherNumber, DeletedAt: rec.Teacher.DeletedAt.Time},
			Subject:       entity.Subject{ID: rec.SubjectID, Name: rec.Subject.Name, DeletedAt: rec.Subject.DeletedAt.Time},
