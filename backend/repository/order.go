		...
		result = append(result, entity.RechargeOrder{
			...
			StudentCourse: entity.StudentSubject{
				...
				Student: entity.Student{
					...
					Status:        int(order.StudentCourse.Student.Status),
					CreatedAt:     order.StudentCourse.Student.CreatedAt,
					UpdatedAt:     order.StudentCourse.Student.UpdatedAt,
					DeletedAt:     order.StudentCourse.Student.DeletedAt.Time,
				},
				Subject: entity.Subject{
					...
					CreatedAt:     order.StudentCourse.Subject.CreatedAt,
					UpdatedAt:     order.StudentCourse.Subject.UpdatedAt,
					DeletedAt:     order.StudentCourse.Subject.DeletedAt.Time,
				},
				Teacher: entity.Teacher{
					ID:        order.StudentCourse.Teacher.ID,
					Name:      order.StudentCourse.Teacher.Name,
					DeletedAt: order.StudentCourse.Teacher.DeletedAt.Time,
				},
			},
			Hours:     order.Hours,
			Amount:    order.Amount,
