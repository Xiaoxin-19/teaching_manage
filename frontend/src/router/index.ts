...
const routes = [
  ...
  { path: '/subjects', name: 'subjects', component: () => import('../views/SubjectManager/SubjectManage.vue') }, { path: '/records', name: 'records', component: () => import('../views/RecordManager/RecordManage.vue') },
